...
metros = float(input('Informe o tamanho em metros quadrados da área a ser pintada: ')) #area em metros quadrados.
metros_com_folga = metros * 1.1

litros_por_metro = 6
litros_a_serem_usados = metros_com_folga / litros_por_metro
litros_por_lata = 18
